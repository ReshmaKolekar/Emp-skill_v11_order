...
public class EmployeeController {
	...
	public Object createUser(@Valid @RequestBody EmployeeDto employee) {
	...
	public ResponseEntity<EmployeeDto> addEmpskill(@PathVariable(value = "id") int id, @RequestBody SkillList skillList)
			throws RecordNotFoundException {
	...
	public ResponseEntity<?> updateEmpSkill(@PathVariable(value = "empId") int empid,
			@PathVariable(value = "skillName") String skillName, @RequestBody Skills skill)
			throws InternalServerError, RecordNotFoundException {
	...
	public ResponseEntity<?> updateEmpSkills(@PathVariable(value = "empid") int empid, @RequestBody SkillList skillList)
			throws InternalServerError, RecordNotFoundException {
	...
	@ApiOperation(value = "Save user certificatinos ")
	@PostMapping("/addemployeecertifications/{id}")
	public ResponseEntity<EmployeeDto> addEmpCertifications(@PathVariable(value = "id") int id, @RequestBody CertificationList certificationList)
			throws RecordNotFoundException {

		EmployeeDto employee = employeeService.addEmpCertifications(id, certificationList);
		return ResponseEntity.ok().body(employee);
	}
}
